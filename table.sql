...
insert column[ "title" , varchar ("32") values [(" OS, Android" ) , (Street fighter" ),(tekken"), (" Ronin" )("call of dragons "),("OS, Android")];
...
INSERT ROW [ GAME 5 VARCHAR 16 VALUES [("BATTLEGROUNDS INDIA") ("")];
insert into column() where values [()];
